...
2. Make sure you have Virtualbox and Vagrant installed on your local machine 
3. In the project directory, run 'vagrant up' to provision VMs, one a control VM and another VM hosting the Web Application 
4. Once the environment is up, open a browser on your local machine and access the application with 'http://localhost:8001'
5. Enter few Users by filling the form and clicking the 'Send' button after every entry.
6. Click on the 'Users' button to see a list of users you entered below the form.
